...
a4 = a.intersect(Line.new(-ONE, EIGHT))
if not (a4.x == THREE and a4.y == FIVE)
  puts "Point intersect not working properly"
end
a5 = a.intersect(VerticalLine.new(THREE))
if not (a5.x == THREE and a5.y == FIVE)
  puts "Point intersect not working properly"
end
a6 = a.intersect(LineSegment.new(TWO, FOUR, FOUR, SIX))
...
b4 = b.intersect(Point.new(ZERO, FIVE))
if not (b4.is_a? Point and b4.x == ZERO and b4.y == FIVE)
  puts "Line intersect not working properly"
end
b5 = b.intersect(VerticalLine.new(ZERO))
if not (b5.is_a? Point and b5.x == ZERO and b5.y == FIVE)
  puts "Line intersect not working properly"
end
b6 = b.intersect(LineSegment.new(-ONE, FOUR, ONE, SIX))
if not (b6.is_a? Point and b6.x == ZERO and b6.y == FIVE)
  puts "Line intersect not working properly"
end
...
c4 = c.intersect(Point.new(THREE, FOUR))
if not (c4.is_a? Point and c4.x == THREE and c4.y == FOUR)
	puts "VerticalLine intersect not working properly"
end
c5 = c.intersect(Line.new(ONE, ONE))
if not (c5.is_a? Point and c5.x == THREE and c5.y == FOUR)
	puts "VerticalLine intersect not working properly"
end
