  ...
  case e of
      ...
      | LineSegment (x1, y1, x2, y2)  => if real_close (x1,x2) 
					 then if real_close (y1,y2)
					      then Point (x1, y1) (* case 1: real close end and start, replaced by a Point *)
					      else if y1 < y2
					      then LineSegment (x1, y1, x2, y2) (* case 2: real close start, smaller y to the left *)
					      else LineSegment (x2, y2, x1, y1)
					 else if x1 < x2
					 then LineSegment (x1, y1, x2, y2) (* case 3: not close, smaller x to the left *)
					 else LineSegment (x2, y2, x1, y1)
      | Var s => Var s
